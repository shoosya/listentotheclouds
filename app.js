...
var a = new Vue({
  ...
  mounted: function () {
    ...
    if (lang && lang.indexOf("ru") > -1) {
      ...
      $("#yesbtn").text("да");
      $("#donatepp").text(
        "Спасибо - Нажмите здесь, чтобы пожертвовать любую сумму, которую вы хотите"
      );
    }
  ...
  methods: {
    ...
    getAirports: function () {
      ...
      var fil = airports.filter(function (cv) {
...
var scsrc =
  "https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/5281179&amp;color=00aabb&amp;auto_play=true&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&start_track=" +
  getRandomInt(0, 152);
...
var spacestream =
  "http://www.ustream.tv/embed/17074538?v=3&wmode=direct&autoplay=true";
var origbg = null;
var isInspace = false;
function spaceModeOn() {
  ...
  $v.html(
    '<iframe width="720" height="437" src="http://www.ustream.tv/embed/17074538?v=3&wmode=direct&autoplay=true" scrolling="no" frameborder="0" style="border: 0px none transparent;"></iframe>'
  );
}
